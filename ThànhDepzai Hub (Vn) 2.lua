...
shared.LoaderTitle = "ThànhDepzai Hub (Vn)";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://107842247226905",
...
local v8 = CreateObject("TextLabel", {
    ...
    Parent = v6,
    BackgroundTransparency = 1,
    Text = "Hiện ko cóa đợi kiếp sau đi",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=107842247226905";
v24.Parent = v23;
