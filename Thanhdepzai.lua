...
local function createFirework()
    ...
    firework.Texture = "rbxassetid://129857818198104"
    firework.Rate = 50
...
ImageButton.Image = "http://www.roblox.com/asset/?id=129857818198104"
...
local Window = Fluent:CreateWindow({
    Title="ThànhDepzai Hub",
    SubTitle="By ThànhDepzai6B",
    TabWidth=157,
...
-- Tab 0
Tabs.Main0:AddButton({Title="hiền tại đéo có",Description="hiền tại đéo có",Callback=function() setclipboard("https://discord.gg/qEkEHgkQ") end})
Tabs.Main0:AddButton({Title="hiền tại đéo có",Description="hiền tại đéo có",Callback=function() setclipboard("https://youtube.com/@vtd.roblox1?si=A5NM7LD-DIOE3a_0") end})
